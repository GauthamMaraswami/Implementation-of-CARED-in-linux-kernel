...
//Call CARED function for calculating qavg       
...
static inline void red_cautiously_adaptative_timer(unsigned long arg)
{
...
static int red_init(struct Qdisc *sch, struct nlattr *opt)
{
	...
	q->qdisc = &noop_qdisc;
	setup_timer(&q->adapt_timer, red_cautiously_adaptative_timer, (unsigned long)sch);
